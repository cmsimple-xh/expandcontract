...
$plugin_tx['expandcontract']['link_single_page']="<code>{{{expand 'pages = Page X', 'headlines = linktext'}}}</code><br><i>Creates an expand link with specified \"link text\" to page \"Page X\".</i>";
$plugin_tx['expandcontract']['link_multiple_pages']="<code>{{{expand 'pages = Page 1,Page 2,Page 3,Page 4'}}}</code><br><i>Creates expand links to the pages \"Page 1\", \"Page 2\", \"Page 3\", \"Page 4\".</i>";
