...
$plugin_tx['expandcontract']['link_single_page']="<code>{{{expand 'pages = Seite X', 'headlines = Linktext'}}}</code><br><i>Erzeugt einen Expand-Link mit angegebenem \"Linktext\" zur Seite \"Seite X\".</i>";
$plugin_tx['expandcontract']['link_multiple_pages']="<code>{{{expand 'pages = Seite 1, Seite 2, Seite 3, Seite 4'}}}</code><br><i>Erzeugt Expand-Links zu den Seiten \"Seite 1\", \"Seite 2\", \"Seite 3\", \"Seite 4\".</i>";
