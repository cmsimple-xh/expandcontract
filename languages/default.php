...
$plugin_tx['expandcontract']['link_single_page']="<code>{{{expand('pages = Seite X', 'headlines = Linktext')}}}</code><br><i>Creates an expand link with specified \"link text\" to page \"Page X\".<br>Can be within a line in a paragraph defined as DIV or as the last word in a paragraph.</i>";
$plugin_tx['expandcontract']['link_multiple_pages']="<code>{{{expand('pages = Seite 1, Seite 2, Seite 3, Seite 4')}}}</code><br><i>Creates expand links to the pages \"Page 1\", \"Page 2\", \"Page 3\", \"Page 4\".</i>";
